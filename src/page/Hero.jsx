...
const Hero = () => {
  ...
  <a 
    href="#contact" 
    className="
      inline-block rounded-full bg-[#F1A7C6] px-6 md:px-6 lg:px-8 py-2.5 md:py-3 text-xs lg:text-sm font-bold text-slate-900 shadow-[0_0_20px_rgba(241,167,198,0.3)] transition transform hover:bg-rose-300 hover:-translate-y-1 whitespace-nowrap"
  >
    Get in Touch
  </a>
